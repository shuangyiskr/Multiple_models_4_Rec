...
MODEL_PATH = "models/ibcf_model.pkl"
RECOMMENDATIONS_PATH = "results/ibcf_recommendations.txt"
...
def inference():
    ...
    for user_id in tqdm(test_data["user_id"].unique(), desc="Generating Recommendations"):
        try:
            recommendations[user_id] = ibcf_model.recommend(user_id, top_k=10)
        except ValueError:
